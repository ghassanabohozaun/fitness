                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                name="title_en" id="title_en" value="{{ $new->title_en }}"
                                placeholder="{{ __('news.enter_title_en') }}" autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-solid form-control-lg summernote"
                                placeholder="{{ __('news.enter_details_en') }}" name="details_en" id="details_en">{{ $new->details_en }}</textarea>
