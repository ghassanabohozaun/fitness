                ...
                <div class="col-xl-9">
                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            <label>{{ __('news.title_ar') }}</label>
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                name="title_ar" id="title_ar" placeholder="{{ __('news.enter_title_ar') }}"
                                autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-solid form-control-lg summernote"
                                placeholder="{{ __('news.enter_details_ar') }}" name="details_ar" id="details_ar"></textarea>
