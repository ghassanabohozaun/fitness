                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                ...
                                autocomplete="off" value="{!! $service->title_ar !!}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                ...
                                autocomplete="off" value="{!! $service->summary_ar !!}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" name="details_ar" id="details_ar">{!! $service->details_ar !!}</textarea>
