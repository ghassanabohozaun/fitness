<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div style="margin-top:18px" id="kt_aside_menu" class="aside-menu " data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav ">
            ...
            @can('students')
                <li class="menu-item  menu-item-submenu
                   @if (str_contains(url()->current(), '/students')) menu-item-open @endif"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{!! route('admin.students') !!}" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">{{ __('menu.students') }}</span>
                        <span class="menu-label">
            ...
            @can('courses')
                <li class="menu-item  menu-item-submenu
                   @if (str_contains(url()->current(), '/courses')) menu-item-open @endif"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{!! route('admin.courses') !!}" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">{{ __('menu.courses') }}</span>
                        <span class="menu-label">
                            <span class="label label-rounded label-danger">
