                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight-bolder text-info text-gradient">{!! __('login.welcome_back') !!}</h3>
                                    <p class="mb-0"> {!! __('login.enter_your_email_and_password_to_sign_in') !!}</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="post" action="{!! route('patient.login') !!}"
                                        ...
                                        <div class="mb-3">
                                            <input type="email" name="email" class="form-control"
                                                placeholder="{!! __('login.enter_email') !!}" aria-label="Email"
                                                aria-describedby="email-addon">
                                        </div>
                                        <label>{!! __('login.password') !!}</label>
                                        <div class="mb-3">
                                            <input type="password" name="password" class="form-control"
                                                placeholder="{!! __('login.enter_password') !!}" aria-label="Password"
                                        ...
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label"
                                                for="rememberMe">{!! __('login.remember_me') !!}</label>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit"
                                                class="btn bg-gradient-info w-100 mt-4 mb-0">{!! __('login.sign_in') !!}</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-sm mx-auto">
                                        ...
                                        <a href="javascript:;"
                                            class="text-info text-gradient font-weight-bold">{!! __('login.sign_up') !!}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8 ">
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                                    style="background-image:url('{!! asset('patient/assets/img/curved-images/curved6.jpg') !!}')"></div>
                            </div>
                        </div> --}}
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center mt-1">
                    <p class="mb-0 text-secondary">
                        ...
                        </script> <b> {!! setting()->{'site_name_' . Lang()} !!}</b>
                    </p>
                </div>
            </div>
        </div>
